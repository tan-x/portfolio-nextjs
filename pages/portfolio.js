				...
				<div className="modal-dialog">
					...
					<div className="modal-content">
					  ...
					  <div className="modal-footer">
						<a type="button" className="btn btn-default" id="repo" href="" target="_blank"><i className="fab fa-github fa-lg"></i> GitHub Repo</a>
						<a type="button" className="btn btn-default" id="link" href="" target="_blank"><i className="fa fa-external-link"></i> Link</a>
